...
% Again, the address lines must be centered over entire width of resume:
 ...
 %\moveleft.5\hoffset\centerline{\url{http://www.framebit.org}}

\begin{resume}
\vspace{-10pt}
\section{OBJECTIVE} Full-time employment in backend systems design starting Fall 2015

\section{EDUCATION} {\sl \textbf{Bachelor of Science: Computer Science}} - Media, Systems \& Architecture \\
                    Georgia Institute of Technology, Atlanta, GA\\
                    Expected Graduation: Summer, 2015; GPA: in progress\\        
                    \\
                    ...
                    Graduated May, 2011; GPA: 3.997 out of 4.0
\section{LANGUAGES} 
                {\sl \textbf{Experienced With:}} C, Java, Ruby, Sinatra framework\\
                {\sl \textbf{Familiar With:}} C\#, Bash, CSS, HTML, pthreads library\\
                {\sl \textbf{Dabbled In \& Curious About:}} Ruby on Rails, PHP, SQL, SASS, C++
\section{SKILLS} 
                {\sl \textbf{Misc. Development Tools: }} Git, Github, Subversion, Mingle, Pivotal Tracker, command line operation, \LaTeX \\
